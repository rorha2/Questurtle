...
const bagScreen =
document.getElementById("bag-screen");
...
document.getElementById("current-user-card");

const currentUserIcon =
document.getElementById("current-user-icon");
...
const turtleExp =
document.getElementById("turtle-exp");
...
const bagButton =
document.getElementById("bag-button");
